...
class ColorShades implements Color, ColorSwatch {
  ...
  static Color _fromAHSL(double a, double h, double s, double l) {
  ...
  Color get s50 => _colors[50]!;
  Color get s100 => _colors[100]!;
  Color get s200 => _colors[200]!;
  Color get s300 => _colors[300]!;
  Color get s400 => _colors[400]!;
  Color get s500 => _colors[500]!;
  Color get s600 => _colors[600]!;
  Color get s700 => _colors[700]!;
  Color get s800 => _colors[800]!;
  Color get s900 => _colors[900]!;
  Color get s950 => _colors[950]!;
