...
enum StepSize {
  s2(_s2Size, ks2StepIndicatorSize),
  w5(_mediumSize, kMediumStepIndicatorSize),
  s4(_largeSize, kLargeStepIndicatorSize);
...
Widget _s2Size(BuildContext context, Widget child) {
  return child.text2().icon2();
}

Widget _mediumSize(BuildContext context, Widget child) {
  return child.textW4().icon4();
}

Widget _largeSize(BuildContext context, Widget child) {
  return child.text4().icon4();
}
...
const ks2StepIndicatorSize = 36.0;
                    ...
                    decoration: WidgetStateProperty.resolveWith(
                      (states) {
                        return BoxDecoration(
                          shape: theme.radiuses.scaling == 0 ? BoxShape.rectangle : BoxShape.circle,
                          color: properties.state.value.stepStates[stepIndex] == StepState.failed
                              ? theme.colorScheme.destructive
                              : properties.state.value.currentStep > stepIndex
                                  ? theme.colorScheme.primary
