          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  data.title.textW6().textSecondaryForeground().text3().withPadding(left: 4 * scaling),
                  if (data.content != null) Gap(8 * scaling),
                  if (data.content != null) Expanded(child: data.content!.text2().textMuted()),
                ],
              ),
            )
          ],
