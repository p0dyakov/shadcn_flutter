...
class _DrawerWrapperState extends State<DrawerWrapper> with SingleTickerProviderStateMixin {
      ...
      case OverlayPosition.right:
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: theme.radiuses.r6Circular,
          ),
        );
      case OverlayPosition.top:
      case OverlayPosition.bottom:
  ...
  BoxDecoration getDecoration(ThemeData theme) {
    ...
    var borderRadius = widget.borderRadius ?? getBorderRadius(theme.radiuses.r6);
  ...
  Widget build(BuildContext context) {
    ...
    if (surfaceBlur != null && surfaceBlur > 0) {
      container = SurfaceBlur(
        surfaceBlur: surfaceBlur,
        borderRadius: getBorderRadius(theme.radiuses.r6),
        child: container,
      );
    }
                      ...
                      builder: (context, child) {
                        ...
                        return Data.inherit(
                          ...
                          child: Transform.scale(
                            scale: scale,
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(theme.radiuses.r6 * animation.value),
                              child: child,
                            ),
                          ),
                        );
