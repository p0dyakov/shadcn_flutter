  ...
  Widget build(BuildContext context) {
    ...
    return Clickable(
      ...
      child: Row(
        ...
        children: [
          if (widget.leading != null) widget.leading!.text2().textW5(),
                ...
                : Center(
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(theme.radiuses.r1),
                      ),
                    ),
                  ),
          ),
          SizedBox(width: theme.scaling * 8),
          if (widget.trailing != null) widget.trailing!.text2().textW5(),
        ],
      ),
    );
  }
...
class AnimatedCheckPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    double secondStrokeProgress = (progress - normalizedFirstStrokeLength).clamp(0.0, normalizedSecondStrokeLength) /
