...
import 'package:shadcn_flutter/src/component/focus_outline.dart';
...
class Clickable extends StatefulWidget {
  ...
  final WidgetStateProperty<IconThemeData?>? icons;
...
class _ClickableState extends State<Clickable> {
  ...
  Widget _builder(BuildContext context, Widget? _) {
    ...
    if (decoration is BoxDecoration) {
      borderRadius = decoration.borderRadius ?? theme.radiuses.r3Circular;
    } else {
        ...
        child: FocusableActionDetector(
          ...
          child: DefaultTextStyle.merge(
            ...
            child: IconTheme.merge(
              data: widget.icons?.resolve(widgetStates) ?? const IconThemeData(),
