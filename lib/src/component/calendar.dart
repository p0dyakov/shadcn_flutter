                  ...
                  child: Row(
                    ...
                    children: [
                      OutlineButton(
                        ...
                        child: const Icon(LucideIcons.arrowLeft).icon1(),
                      ),
                      SizedBox(
                      ...
                      Expanded(
                        child: GhostButton(
                          ...
                          child: Text(getHeaderText(localizations, _view, _viewType))
                              ...
                              .textW5()
                              .textCenter(),
                        ).withSized(height: theme.scaling * 32),
                      ),
                      ...
                      if (_viewType != CalendarViewType.date || viewMode != CalendarSelectionMode.range)
                        OutlineButton(
                          ...
                          child: const Icon(LucideIcons.arrowRight).icon1(),
                        ),
                    ],
                  ),
                ),
              ...
              decoration: (context, states, value) {
                return (value as BoxDecoration).copyWith(
                  borderRadius: indexAtRow == 0
                      ? BorderRadius.only(
                          topLeft: Radius.circular(theme.radiuses.r3),
                          bottomLeft: Radius.circular(theme.radiuses.r3),
                        )
                      : indexAtRow == rowCount - 1
                          ? BorderRadius.only(
                              topRight: Radius.circular(theme.radiuses.r3),
                              bottomRight: Radius.circular(theme.radiuses.r3),
                            )
                          : BorderRadius.zero,
                );
              },
    ...
    for (int i = 0; i < 7; i++) {
      ...
      weekDays.add(
        Container(
          ...
          height: theme.scaling * 32,
          alignment: Alignment.center,
          child: Text(localizations.getAbbreviatedWeekday(weekday)).textMuted().text1(),
        ),
      );
    }
    rows.add(Row(
