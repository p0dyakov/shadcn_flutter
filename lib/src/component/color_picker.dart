    ...
    return Container(
      decoration: selectedColor != null && color == selectedColor
          ? BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(theme.radiuses.r3),
            )
          : null,
      child: AspectRatio(
        aspectRatio: 1,
...
class _ColorPickingLayerState extends State<ColorPickingLayer> implements ColorPickingLayerScope {
  ...
  Widget _buildPreviewLabel(BuildContext context, Color color) {
    ...
    return Text(colorToHex(color, false)).text2().textMuted();
  }
                  ...
                  child: Container(
                    ...
                    child: widget.mode == ColorPickerMode.hsl
                        ? HSLColorPickerArea(
                            ...
                            radius: Radius.circular(theme.radiuses.r4),
                            reverse: true,
                            onColorChanged: (value) {
                      ...
                      if (widget.showAlpha)
                        _wrapTextField(
                          child: Column(
                            ...
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Text(localizations.colorAlpha).textMuted().text2(),
                              Gap(theme.scaling * 4),
                              TextField(
                                onEditingComplete: _onColorChange,
                  ...
                  : HSVColorPickerArea(
                      ...
                      onColorChanged: (value) {
                        widget.onColorChanged
                            ?.call(widget.color.changeToHSVValue(value.value).changeToHSVSaturation(value.saturation));
                      },
                      sliderType: HSVColorSliderType.satVal,
                      reverse: true,
                      onColorEnd: (value) {
...
class ColorInput extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ObjectFormField(
      ...
      density: !showLabel ? ButtonDensity.iconDense : ButtonDensity.w4,
        ...
        if (!showLabel) {
          return Container(
            decoration: BoxDecoration(
              ...
              borderRadius: theme.radiuses.r2Circular,
            ),
          );
        }
        return IntrinsicHeight(
