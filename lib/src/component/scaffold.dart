...
class AppBar extends StatefulWidget {
  ...
  final Widget? child;
  final Widget? title;
  final Widget? header; // s2 widget placed on top of title
  final Widget? subtitle; // s2 widget placed below title
              ...
              child: SizedBox(
                ...
                child: IntrinsicHeight(
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.stretch,
                    children: [
                      if (widget.showBackButton || widget.leading.isNotEmpty)
                        Row(
                              ...
                              ? [
                                  GestureDetector(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Icon(BootstrapIcons.arrowLeft),
                                    ),
                                  ),
                                ]
                              : widget.leading,
                              ...
                              children: [
                                if (widget.header != null)
                                  KeyedSubtree(
                                    ...
                                    child: widget.header!.textMuted().text2(),
                                  ),
                                if (widget.title != null)
                                  KeyedSubtree(
                                    key: const ValueKey('title'),
                                    child: widget.title!.text4().textW5(),
                                  ),
                                if (widget.subtitle != null)
                                  KeyedSubtree(
                                    key: const ValueKey('subtitle'),
                                    child: widget.subtitle!.text2().textMuted(),
                                  ),
                              ],
                            ),
                      ),
