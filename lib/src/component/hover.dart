    ...
    return TapRegion(
      ...
      child: MouseRegion(
        ...
        child: GestureDetector(
          onLongPressDown: enableLongPress ? (details) => _onEnter() : null,
          onLongPressCancel: enableLongPress ? () => _onExit(true) : null,
          onLongPressUp: enableLongPress ? () => _onExit(true) : null,
          child: widget.child,
        ),
      ),
    );
