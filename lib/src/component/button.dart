...
class ButtonState<T extends Button> extends State<T> {
  ...
  IconThemeData _resolveIconTheme(Set<WidgetState> states) {
    return _style!.icons(context, states);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Clickable(
      ...
      icons: WidgetStateProperty.resolveWith(_resolveIconTheme),
...
class ButtonSize {
  ...
  static const ButtonSize s1 = ButtonSize(1 / 2);
  static const ButtonSize s2 = ButtonSize(3 / 4);
  static const ButtonSize s3 = ButtonSize(1);
  static const ButtonSize s4 = ButtonSize(2);
  static const ButtonSize s5 = ButtonSize(3);
}
...
class ButtonDensity {
  ...
  static const ButtonDensity w4 = ButtonDensity(_densityNormal);
...
abstract class AbstractButtonStyle {
  ...
  ButtonStateProperty<IconThemeData> get icons;
...
class ButtonStyle implements AbstractButtonStyle {
  ...
  const ButtonStyle({
    ...
    this.size = ButtonSize.s3,
    this.density = ButtonDensity.w4,
  ...
  @override
  ButtonStateProperty<EdgeInsetsGeometry> get padding {
    if (size == ButtonSize.s3 && density == ButtonDensity.w4) {
...
abstract class ButtonTheme {
  ...
  final ButtonStatePropertyDelegate<IconThemeData>? icons;
  final ButtonStatePropertyDelegate<EdgeInsetsGeometry>? margin;

  const ButtonTheme({this.decoration, this.mouseCursor, this.padding, this.textStyle, this.icons, this.margin});
  ...
  @override
  int get hashCode => Object.hash(decoration, mouseCursor, padding, textStyle, icons, margin);

  @override
  String toString() =>
      '$runtimeType{decoration: $decoration, mouseCursor: $mouseCursor, padding: $padding, textStyle: $textStyle, icons: $icons, margin: $margin}';
}
...
class ComponentThemeButtonStyle<T extends ButtonTheme> implements AbstractButtonStyle {
  ...
  @override
  ButtonStateProperty<IconThemeData> get icons => _resolveIconTheme;

  IconThemeData _resolveIconTheme(BuildContext context, Set<WidgetState> states) {
    var resolved = fallback.icons(context, states);
    return find(context)?.icons?.call(context, states, resolved) ?? resolved;
  }
...
class PrimaryButtonTheme extends ButtonTheme {
  const PrimaryButtonTheme(
      {super.decoration, super.mouseCursor, super.padding, super.textStyle, super.icons, super.margin});
  ...
  PrimaryButtonTheme copyWith({
    ...
    ButtonStatePropertyDelegate<IconThemeData>? icons,
...
class ButtonVariance implements AbstractButtonStyle {
  ...
  static const AbstractButtonStyle secondary = ComponentThemeButtonStyle<SecondaryButtonTheme>(
    fallback: ButtonVariance(
      ...
      icons: _buttonSecondaryIconTheme,
      margin: _buttonZeroMargin,
    ),
  );
  ...
  static const AbstractButtonStyle destructive = ComponentThemeButtonStyle<DestructiveButtonTheme>(
    fallback: ButtonVariance(
      ...
      icons: _buttonDestructiveIconTheme,
      margin: _buttonZeroMargin,
    ),
  );
  ...
  @override
  final ButtonStateProperty<IconThemeData> icons;
  @override
  ...
  @override
  int get hashCode {
    return Object.hash(decoration, mouseCursor, padding, textStyle, icons, margin);
  }

  @override
  String toString() {
    return 'ButtonVariance(decoration: $decoration, mouseCursor: $mouseCursor, padding: $padding, textStyle: $textStyle, icons: $icons, margin: $margin)';
  }
}
...
extension ButtonStyleExtension on AbstractButtonStyle {
  ...
  AbstractButtonStyle withForegroundColor({Color? color, Color? hoverColor, Color? focusColor, Color? disabledColor}) {
    return copyWith(
      ...
      icons: (context, states, icons) {
        return icons.copyWith(
          color: states.disabled
              ? disabledColor ?? icons.color
              : states.hovered
                  ? hoverColor ?? icons.color
                  : states.focused
                      ? focusColor ?? icons.color
                      : color,
        );
      },
    );
...
TextStyle _buttonCardTextStyle(BuildContext context, Set<WidgetState> states) {
  ...
  return themeData.typography.s2.copyWith(
...
Decoration _buttonCardDecoration(BuildContext context, Set<WidgetState> states) {
  ...
  if (states.contains(WidgetState.disabled)) {
    return BoxDecoration(
      ...
      borderRadius: BorderRadius.circular(themeData.radiuses.r5),
      border: Border.all(
...
Decoration _buttonMenuDecoration(BuildContext context, Set<WidgetState> states) {
  ...
  if (states.contains(WidgetState.focused) ||
    ...
    return BoxDecoration(
      ...
      borderRadius: BorderRadius.circular(themeData.radiuses.r2),
    );
  }
  return const BoxDecoration();
}
...
Decoration _buttonPrimaryDecoration(BuildContext context, Set<WidgetState> states) {
  ...
  if (states.contains(WidgetState.disabled)) {
    return BoxDecoration(
      ...
      borderRadius: BorderRadius.circular(themeData.radiuses.r3),
    );
  }
...
TextStyle _buttonPrimaryTextStyle(BuildContext context, Set<WidgetState> states) {
  var themeData = Theme.of(context);
  return themeData.typography.s2.merge(themeData.typography.w5).copyWith(
...
TextStyle _buttonStaticTextStyle(BuildContext context, Set<WidgetState> states) {
  final theme = Theme.of(context);
  return theme.typography.s2.merge(theme.typography.w5).copyWith(
  ...
  Widget build(BuildContext context) {
    ...
    if (inherit) {
      ...
      if (data != null) {
        ...
        icons = (context, state, value) {
          return data.icons?.call(context, state, icons?.call(context, state, value) ?? value) ??
              icons?.call(context, state, value) ??
              value;
        };
...
class ButtonStyleOverrideData {
  ...
  @override
  String toString() {
    return 'ButtonStyleOverrideData(decoration: $decoration, mouseCursor: $mouseCursor, padding: $padding, textStyle: $textStyle, icons: $icons, margin: $margin)';
  }
}
