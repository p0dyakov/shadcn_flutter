  ...
  Widget _buildPreviousLabel(ShadcnLocalizations localizations) {
    if (showLabel) {
      return GhostButton(
        ...
        leading: const Icon(RadixIcons.chevronLeft).icon1(),
        child: Text(localizations.buttonPrevious),
      );
    }
    return GhostButton(
      onPressed: hasPrevious ? () => onPageChanged(page - 1) : null,
      child: const Icon(RadixIcons.chevronLeft).icon1(),
    );
  }
  ...
  Widget _buildNextLabel(ShadcnLocalizations localizations) {
    if (showLabel) {
      return GhostButton(
        ...
        trailing: const Icon(RadixIcons.chevronRight).icon1(),
        child: Text(localizations.buttonNext),
      );
    }
    return GhostButton(
      onPressed: hasNext ? () => onPageChanged(page + 1) : null,
      child: const Icon(RadixIcons.chevronRight).icon1(),
    );
  }
