...
import 'package:shadcn_flutter/src/component/hidden.dart';
...
class TextFieldState extends State<TextField>
  ...
  bool get _hasDecoration {
    return widget.placeholder != null || widget.leading != null || widget.trailing != null;
  }
            ...
            : Visibility(
                ...
                child: SizedBox(
                  ...
                  child: DefaultTextStyle(
                    style: textStyle.merge(theme.typography.s2).merge(theme.typography.w4).copyWith(
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.style != null) {
      defaultTextStyle = DefaultTextStyle.of(context)
          .style
          .merge(theme.typography.s2)
          .merge(theme.typography.w4)
          .copyWith(
      ...
      defaultTextStyle =
          DefaultTextStyle.of(context).style.merge(theme.typography.s2).merge(theme.typography.w4).copyWith(
                color: theme.colorScheme.foreground,
              );
    }
    ...
    final BoxDecoration effectiveDecoration = widget.decoration ??
        BoxDecoration(
          borderRadius:
              optionallyResolveBorderRadius(context, widget.borderRadius) ?? BorderRadius.circular(theme.radiuses.r3),
