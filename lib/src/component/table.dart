              ...
              child: GestureDetector(
                ...
                onVerticalDragUpdate: (details) {
                  if (heightMode == TableCellResizeMode.reallocate) {
                    ...
                    widget.controller
                        .resizeRow(row - 1, widget.controller.getRowHeight(row - 1) + details.primaryDelta!);
                  }
                },
              ...
              child: GestureDetector(
                ...
                onVerticalDragUpdate: (details) {
                  if (heightMode == TableCellResizeMode.reallocate) {
                    ...
                    widget.controller.resizeRow(
                        row + rowSpan - 1, widget.controller.getRowHeight(row + rowSpan - 1) + details.primaryDelta!);
                  }
                },
                onVerticalDragEnd: _onDragEnd,
                onVerticalDragCancel: _onDragCancel,
                child: ListenableBuilder(
                  ...
                  builder: (context, child) {
                    ...
                    return Container(
                      color: (hover?.index == row + rowSpan - 1 && hover?.direction == Axis.horizontal) ||
              ...
              child: GestureDetector(
                ...
                onHorizontalDragUpdate: (details) {
                  if (widthMode == TableCellResizeMode.reallocate) {
                    ...
                    widget.controller
                        .resizeColumn(column - 1, widget.controller.getColumnWidth(column - 1) + details.primaryDelta!);
                  }
                },
              ...
              child: GestureDetector(
                ...
                onHorizontalDragUpdate: (details) {
                  if (widthMode == TableCellResizeMode.reallocate) {
                    ...
                    widget.controller.resizeColumn(column + columnSpan - 1,
                ...
                child: ListenableBuilder(
                  ...
                  builder: (context, child) {
                    ...
                    return Container(
                      color: (hover?.index == column + columnSpan - 1 && hover?.direction == Axis.vertical) ||
...
class TableHeader extends TableRow {
  ...
  TableCellTheme buildDefaultTheme(BuildContext context) {
    ...
    return TableCellTheme(
      ...
      textStyle: WidgetStateProperty.resolveWith(
        (states) {
          return theme.typography.w6.merge(TextStyle(
            color: states.contains(WidgetState.disabled) ? theme.colorScheme.muted : null,
          ));
        },
      ),
