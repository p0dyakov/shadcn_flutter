...
class CommandEmpty extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Center(child: Text(localizations.commandEmpty).withPadding(vertical: 24).text2());
  }
}
  ...
  return showDialog<T>(
    ...
    builder: (context) {
      ...
      return ConstrainedBox(
        ...
        child: ModalBackdrop(
          borderRadius: subtractByBorder(theme.radiuses.r6Circular, 1 * scaling),
...
class CommandCategory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        if (title != null)
          title!.withPadding(horizontal: theme.scaling * 8, vertical: theme.scaling * 6).textW5().text1().textMuted(),
        ...children,
      ],
    ...
    return GestureDetector(
      ...
      child: FocusableActionDetector(
        ...
        child: AnimatedContainer(
          ...
          child: IconTheme(
            data: themeData.icons.s2.copyWith(
            ...
            child: DefaultTextStyle(
              ...
              child: Row(
                children: [
                  ...
                  if (widget.trailing != null) widget.trailing!.textMuted().text1(),
                ],
              ).text2(),
            ),
          ),
