...
class _SliderState extends State<Slider> with FormValueSupplier<SliderValue, Slider> {
              ...
              onHorizontalDragStart: !enabled
                  ...
                  : (details) {
                      ...
                      if (_currentValue.isRanged) {
                        ...
                        SliderValue newSliderValue = SliderValue.single(value * (widget.max - widget.min) + widget.min);
                        _dispatchValueChangeStart(newSliderValue);
                      }
                    },
                      ...
                      ? (details) {
                          ...
                          if (_moveStart) {
                            ...
                            var newSliderValue = SliderValue.ranged(
                                min(startSliderValue, endSliderValue), max(startSliderValue, endSliderValue));
                            _dispatchValueChange(newSliderValue);
                            setState(() {
                              _currentValue = SliderValue.ranged(newStart, newEnd);
                            });
              ...
              onHorizontalDragEnd: !enabled
                  ...
                  : (details) {
                      ...
                      if (_currentValue.isRanged) {
                        ...
                        var newStart = min(start, end);
                        var newEnd = max(start, end);
                        _dispatchValueChangeEnd(SliderValue.ranged((newStart * (widget.max - widget.min) + widget.min),
            ...
            child: Center(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(theme.radiuses.r2),
                ),
              ),
            ),
          );
  ...
  Widget buildThumb(BuildContext context, BoxConstraints constraints, ThemeData theme, double value, bool focusing,
      ValueChanged<bool> onFocusing, VoidCallback onIncrease, VoidCallback onDecrease) {
    final theme = Theme.of(context);
    final scaling = theme.scaling;
    if (widget.divisions != null) {
      value = (value * widget.divisions!).round() / widget.divisions!;
      ...
      children: [
        ...
        buildThumb(
          ...
          () {
            ...
            var newSliderValue = SliderValue.ranged(sliderValue * (widget.max - widget.min) + widget.min,
        ...
        buildThumb(
          ...
          () {
            ...
            var newSliderValue = SliderValue.ranged(_currentValue.start * (widget.max - widget.min) + widget.min,
