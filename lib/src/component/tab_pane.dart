...
import 'package:shadcn_flutter/src/component/fade_scroll.dart';
...
class TabPaneState<T> extends State<TabPane<T>> {
  ...
  Widget _childBuilder(BuildContext context, TabContainerData data, Widget child) {
    ...
    final borderRadius = (widget.borderRadius ?? theme.radiuses.r4Circular).optionallyResolve(context);
  ...
  Widget build(BuildContext context) {
    ...
    final BorderRadiusGeometry borderRadius = widget.borderRadius ?? theme.radiuses.r4Circular;
