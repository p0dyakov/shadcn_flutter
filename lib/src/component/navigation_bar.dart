...
class NavigationBar extends StatefulWidget {
  ...
  const NavigationBar({
    ...
    this.labelSize = NavigationLabelSize.s2,
    this.padding,
    this.constraints,
    this.expands = true,
    this.index,
...
class NavigationSidebar extends StatefulWidget {
  ...
  const NavigationSidebar({
    ...
    this.labelSize = NavigationLabelSize.s4,
    this.padding,
    this.constraints,
    this.index,
    this.onSelected,
    ...
    Widget? label = widget.label == null
        ...
        : DefaultTextStyle.merge(
            ...
            child: _NavigationChildOverflowHandle(
              ...
              child: data?.parentLabelSize == NavigationLabelSize.s2 ? widget.label!.text1() : widget.label!,
            ),
          );
  ...
  Widget buildBox(BuildContext context, NavigationControlData? data) {
    ...
    return DefaultTextStyle.merge(
      ...
      child: Container(
        ...
        child: buildChild(context, data).text1(),
      ),
    );
  }
