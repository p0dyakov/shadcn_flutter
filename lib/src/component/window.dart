...
import 'package:shadcn_flutter/src/component/group.dart';
import 'package:shadcn_flutter/src/component/patch.dart';
      ...
      child: ListenableBuilder(
        ...
        builder: (context, child) {
          ...
          Widget windowClient = Card(
            ...
            borderRadius: state.maximized != null ? BorderRadius.zero : theme.radiuses.r3Circular,
            child: Column(
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: (_viewport?.focused ?? true)
                                    ...
                                    : (widget.title ?? const SizedBox()).textMuted(),
                              ),
                            ),
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.only(
            topLeft: widget.topLeft ? Radius.circular(theme.radiuses.r2) : Radius.circular(theme.radiuses.r4),
            topRight: widget.topRight ? Radius.circular(theme.radiuses.r2) : Radius.circular(theme.radiuses.r4),
            bottomLeft: widget.bottomLeft ? Radius.circular(theme.radiuses.r2) : Radius.circular(theme.radiuses.r4),
            bottomRight: widget.bottomRight ? Radius.circular(theme.radiuses.r2) : Radius.circular(theme.radiuses.r4),
          ),
        ),
      ),
    );
    ...
    return Row(
      children: [
        ...
        if (handle?.maximizable ?? true)
          IconButton.ghost(
            icon: const Icon(BootstrapIcons.square),
            size: ButtonSize.s2,
            onPressed: () {
              if (handle != null) {
                  ...
                  child: BackdropFilter(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        borderRadius: theme.radiuses.r3Circular,
                      ),
                    ),
                  ),
                ),
