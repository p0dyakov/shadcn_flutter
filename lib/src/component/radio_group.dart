      ...
      child: FocusableActionDetector(
        ...
        child: Data<RadioGroupData<T>>.boundary(
          child: Data<_RadioCardState<T>>.boundary(
            child: Card(
              borderColor:
                  groupData?.selectedItem == widget.value ? theme.colorScheme.primary : theme.colorScheme.muted,
              borderWidth: groupData?.selectedItem == widget.value ? 2 * theme.scaling : 1 * theme.scaling,
