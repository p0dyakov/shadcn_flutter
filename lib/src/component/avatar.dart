...
class _AvatarState extends State<Avatar> {
  Widget _build(BuildContext context) {
    ...
    double borderRadius = widget.borderRadius ?? theme.radiuses.scaling * size;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(borderRadius ?? theme.radiuses.scaling * size),
      ),
      child: child,
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < this.children.length; i++) {
      ...
      if (i == 0) {
        ...
        currentWidth = size;
        currentHeight = size;
        currentBorderRadius = avatar.borderRadius ?? theme.radiuses.scaling * size;
      } else {
        double width = size;
        double height = size;
